    ...
    <div class="row row-height">
        <div class="col-lg-6 content-left">
            <div class="content-left-wrapper">
                ...
                <div class="black-color">
                    ...
                    <h2 class="black-color">Denoncer un acte de violence</h2>
        ...
        <div class="col-lg-6 content-right main-bg" id="start">
            <div id="wizard_container">
                ...
                <?php echo form_open_multipart('welcome/denonce');?>
                ...
                <div id="middle-wizard">
                    ...
                    <div class="submit step">
                        <div class="form-group">
                            <?php
                                    echo form_input([
                                        'name' => 'complain[vic_name]',
                                        'placeholder' => 'Nom victime',
                                        'class' => 'form-control required',
                                        'type' => 'text'
                                    ]);
                                    ?>
                        ...
                        <div class="form-group">
                            <?php
                                    echo form_input([
                                        'name' => 'complain[vic_tel]',
                                        'placeholder' => 'Téléphone victime',
                                        'class' => 'form-control required',
                                        'type' => 'text'
                                    ]);
                                    ?>
                        ...
                        <div class="form-group">
                            <?php
                                    echo form_input([
                                        'name' => 'complain[vic_adress]',
                                        'placeholder' => 'Adresse victime',
                                        'class' => 'form-control required',
                                        'type' => 'text'
                                    ]);
                                    ?>
