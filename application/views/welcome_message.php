...
<nav>
    <ul class="cd-primary-nav">
        <li><a href="" class="animated_link">Se plaindre</a></li>
        <li><a href="index.php/welcome/denonce" class="animated_link">Dénoncer</a></li>
         <li><a href="index.php/welcome/temoigner" class="animated_link">Témoigner</a></li>
        ...
        <div class="col-lg-6 content-left">
            <div class="content-left-wrapper">
                ...
                <div class="black-color">
                    <figure><img src="<?= $assetsUrl ?>img/violence1.png" alt="" class="img-fluid"></figure>
                    <h2 class="black-color">Enregistrer votre plainte</h2>
        ...
        <div class="col-lg-6 content-right main-bg" id="start">
            <div id="wizard_container">
                ...
                <div id="middle-wizard">
                    <div class="step">
                        <h3 class="main_question white-color"><strong class="white-color">1/2</strong>Remplissez le
                        ...
                        <div class="form-group terms">
                            <label class="container_check white-color">Veuillez accepter nos <a href="#"
                                                                                                data-toggle="modal"
                                                                                                style="color: wheat"
                    ...
                    <div class="submit step">
                        <h3 class="main_question white-color"><strong class="white-color">2/2</strong>Décrivez à présent votre plainte</h3>
                        <div class="form-group">
                            <div class="styled-select clearfix">
                                <?php
                                echo form_dropdown('complain[complain_type_id]', $complainTypes, '', [
                                    'class'=>'wide required'
                                ]);
                                ?>
                            </div>
...
<script type="text/javascript">
    if (navigator.geolocation) { //check if geolocation is available
                navigator.geolocation.getCurrentPosition(function(position){
                  ...
                  $.get( "https://maps.googleapis.com/maps/api/js?key=AIzaSyDNacUVQ-CVyugjcd-Dl6mYUmLLvC7KksI&latlng="+ position.coords.latitude + "," + position.coords.longitude +"&sensor=false", function(data) {
                    console.log(data);
                  })
                });   
